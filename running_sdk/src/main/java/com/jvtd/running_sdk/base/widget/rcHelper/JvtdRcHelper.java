...
public class JvtdRcHelper {
    ...
    public void initAttrs(Context context, AttributeSet attrs) {
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.JvtdRcAttrs);
        mRoundAsCircle = ta.getBoolean(R.styleable.JvtdRcAttrs_jvtd_round_as_circle, false);
        mStrokeColorStateList = ta.getColorStateList(R.styleable.JvtdRcAttrs_jvtd_stroke_color);
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.JvtdRcAttrs_jvtd_stroke_width, 0);
        mClipBackground = ta.getBoolean(R.styleable.JvtdRcAttrs_jvtd_clip_background, false);
        int roundCorner = ta.getDimensionPixelSize(R.styleable.JvtdRcAttrs_jvtd_round_corner, 0);
        int roundCornerTopLeft = ta.getDimensionPixelSize(
                R.styleable.JvtdRcAttrs_jvtd_round_corner_top_left, roundCorner);
        int roundCornerTopRight = ta.getDimensionPixelSize(
                R.styleable.JvtdRcAttrs_jvtd_round_corner_top_right, roundCorner);
        int roundCornerBottomLeft = ta.getDimensionPixelSize(
                R.styleable.JvtdRcAttrs_jvtd_round_corner_bottom_left, roundCorner);
        int roundCornerBottomRight = ta.getDimensionPixelSize(
                R.styleable.JvtdRcAttrs_jvtd_round_corner_bottom_right, roundCorner);
        ta.recycle();
    ...
    public void drawableStateChanged(View view) {
        if (view instanceof JvtdRcAttrs) {
            ...
            if (mStrokeColorStateList != null && mStrokeColorStateList.isStateful()) {
                ...
                ((JvtdRcAttrs) view).setStrokeColor(stateColor);
            }
        }
    }
