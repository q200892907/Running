package com.jvtd.running_sdk.base.widget.layout;
...
import com.jvtd.running_sdk.base.widget.rcHelper.JvtdRcAttrs;
import com.jvtd.running_sdk.base.widget.rcHelper.JvtdRcHelper;
 ...
 **/
public class JvtdRcRelativeLayout extends RelativeLayout implements Checkable, JvtdRcAttrs {
    private JvtdRcHelper mRCHelper;

    public JvtdRcRelativeLayout(Context context) {
        this(context, null);
    }

    public JvtdRcRelativeLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public JvtdRcRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mRCHelper = new JvtdRcHelper();
...
//        mRCHelper.refreshRegion(this);
    ...
    public void setOnCheckedChangeListener(JvtdRcHelper.OnCheckedChangeListener listener) {
