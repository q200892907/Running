...
public class JvtdRcImageView extends ImageView implements Checkable, JvtdRcAttrs {

    private JvtdRcHelper mRCHelper;

    public JvtdRcImageView(Context context) {
        this(context, null);
    }

    public JvtdRcImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public JvtdRcImageView(Context context, AttributeSet attrs, int defStyleAttr) {
