...
public class JvtdTokenInterceptor implements Interceptor {
    private static final String TAG = "JvtdTokenInterceptor";
    ...
    public JvtdTokenInterceptor(int error, OnTokenListener onTokenListener) {
